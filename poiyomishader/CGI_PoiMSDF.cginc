	...
	int convertToASCIIText(int text)
	{
		if (text == 27){
			return 32;
		}
    ...
    void ApplyFPSText(inout float4 albedo, float2 uv)
    {
        ...
        float totalCharacters = 12;
        float fpsArray[12];
		fpsArray[0] = convertToASCIIText(_Text1);
        fpsArray[1] = convertToASCIIText(_Text2);
        fpsArray[2] = convertToASCIIText(_Text3);
        fpsArray[3] = convertToASCIIText(_Text4);
        fpsArray[4] = convertToASCIIText(_Text5);
        fpsArray[5] = convertToASCIIText(_Text6);
        fpsArray[6] = convertToASCIIText(_Text7);
		fpsArray[7] = convertToASCIIText(_Text8);
		fpsArray[8] = convertToASCIIText(_Text9);
		fpsArray[9] = convertToASCIIText(_Text10);
		fpsArray[10] = convertToASCIIText(_Text11);
		fpsArray[11] = convertToASCIIText(_Text12);
