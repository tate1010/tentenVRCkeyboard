Shader ".poiyomi/Toon/Advanced/Opaque(TentenEdit)"
{
    Properties
    {
        ...
        // FPS
        [HideInInspector] m_start_TextFPS ("Text", Float) = 0
        [Toggle(_)]_TextFPSEnabled ("Text Text?", Float) = 0
        ...
        _TextFPSPadding ("Padding Reduction", Vector) = (0, 0, 0, 0)
			[HideInInspector]_Text1("text1", int) = 1
			[HideInInspector]_Text2("text2", int) = 1
			[HideInInspector]_Text3("text3", int) = 1
			[HideInInspector]_Text4("text4", int) = 1
			[HideInInspector]_Text5("text5", int) = 1
			[HideInInspector]_Text6("text6", int) = 1
			[HideInInspector]_Text7("text7", int) = 1
			[HideInInspector]_Text8("text8", int) = 1
			[HideInInspector]_Text9("text9", int) = 1
			[HideInInspector]_Text10("text10", int) = 1
			[HideInInspector]_Text11("text11", int) = 1
			[HideInInspector]_Text12("text12", int) = 1
        [HideInInspector] m_end_TextFPS ("Text", Float) = 0
